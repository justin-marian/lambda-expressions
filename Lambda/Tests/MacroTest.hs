module Lambda.Tests.MacroTest (macro_test) where

import Lambda.Sources.Evaluation as Evaluation
import Lambda.Sources.Expr as Expr
import Lambda.Sources.Parser as Parser
import Lambda.Tests.Testing
